...
export default function Input({
  ...
  if (component == 'input') {
    if (type == 'default') {
      ...
      return (
        <div className="input w-full">
          <label className="label-text my-auto me-3 p-0" htmlFor={id}>
            Name
          </label>
          <input
            type="text"
      ...
      return (
        <div className="input w-full">
          ...
          <span className="text-base-content/80 my-auto ms-3 size-5 shrink-0">
            {icon}
          </span>
        </div>
      );
    ...
    if (type == 'default') {
      ...
      return (
        <div className="input w-full">
          <span className="text-base-content/80 my-auto size-5 shrink-0">
            {icon}
          </span>
